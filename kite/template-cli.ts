...
import * as YAML from 'https://deno.land/std@0.56.0/encoding/yaml.ts'
...
It generally expects YAML rendered from a Kite™️ TypeScript program.
A Kite™️ TypeScript program is limited.
It cannot read environment variables or access the network or disk.
This makes configuration as code simple. A Kite™️ program is a program that generates data,
...
The template operation is simple. It will:
 ...
 1. Split the document into individual YAML documents and parse each one.
    ...
    into the KiteConfig resource. This name is used to identify a Kite™️ Stack
 ...
 2. If a TerraformConfig was found, it will be executed and applied. This is
    ...
    Kite™️ manages Terraform providers and state.

 3. Kite™️ Template then performs text templating on the YAML. It will
