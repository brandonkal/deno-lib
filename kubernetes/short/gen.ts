...
export class APIService {
	...
	constructor(data?: any) {
		...
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		...
		this.min_group_priority = ('min_group_priority' in d) ? d.min_group_priority as number : 0;
		this.version_priority = ('version_priority' in d) ? d.version_priority as number : 0;
		this.conditions = Array.isArray(d.conditions) ? d.conditions.map((v: any) => new APIServiceCondition(v)) : null;
	}
}
...
export class ObjectReference {
	...
	constructor(data?: any) {
		...
		this.version = ('version' in d) ? d.version as string : '';
		this.resource_version = ('resource_version' in d) ? d.resource_version as string : '';
...
export class PolicyRule {
	...
	constructor(data?: any) {
		...
		this.resource_names = ('resource_names' in d) ? d.resource_names as string[] : null;
		this.non_resource_urls = ('non_resource_urls' in d) ? d.non_resource_urls as string[] : null;
	}
}
...
export class ClusterRole {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.rules = Array.isArray(d.rules) ? d.rules.map((v: any) => new PolicyRule(v)) : null;
...
export class ClusterRoleBinding {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.subjects = Array.isArray(d.subjects) ? d.subjects.map((v: any) => new Subject(v)) : null;
...
export class Probe {
	...
	constructor(data?: any) {
		...
		this.min_count_success = ('min_count_success' in d) ? d.min_count_success as number : 0;
		this.min_count_fail = ('min_count_fail' in d) ? d.min_count_fail as number : 0;
...
export class ContainerState {
	...
	constructor(data?: any) {
		...
		this.terminated = ('terminated' in d) ? new ContainerStateTerminated(d.terminated) : null;
...
export class Container {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.command = ('command' in d) ? d.command as string[] : null;
		this.args = Array.isArray(d.args) ? d.args.map((v: any) => new FloatOrString(v)) : null;
		...
		this.allow_escalation = ('allow_escalation' in d) ? d.allow_escalation as boolean : null;
		this.rw = ('rw' in d) ? d.rw as boolean : null;
		this.ro = ('ro' in d) ? d.ro as boolean : null;
		this.force_non_root = ('force_non_root' in d) ? d.force_non_root as boolean : null;
		...
		this.liveness_probe = ('liveness_probe' in d) ? new Probe(d.liveness_probe) : null;
		this.readiness_probe = ('readiness_probe' in d) ? new Probe(d.readiness_probe) : null;
		this.expose = Array.isArray(d.expose) ? d.expose.map((v: any) => new Port(v)) : null;
		...
		this.termination_msg_path = ('termination_msg_path' in d) ? d.termination_msg_path as string : '';
		this.termination_msg_policy = ('termination_msg_policy' in d) ? d.termination_msg_policy as string : '';
		...
		this.last_state = ('last_state' in d) ? new ContainerState(d.last_state) : null;
		this.current_state = ('current_state' in d) ? new ContainerState(d.current_state) : null;
		this.volume = Array.isArray(d.volume) ? d.volume.map((v: any) => new VolumeMount(v)) : null;
...
export class JSONSchemaPropsOrArray {
	...
	constructor(data?: any) {
		...
		this.JSONSchemas = Array.isArray(d.JSONSchemas) ? d.JSONSchemas.map((v: any) => new JSONSchemaProps(v)) : null;
	}
}
...
export class JSONSchemaProps {
	...
	constructor(data?: any) {
		...
		this.exclusiveMaximum = ('exclusiveMaximum' in d) ? d.exclusiveMaximum as boolean : false;
		this.minimum = ('minimum' in d) ? d.minimum as number : null;
		this.exclusiveMinimum = ('exclusiveMinimum' in d) ? d.exclusiveMinimum as boolean : false;
		...
		this.enum = Array.isArray(d.enum) ? d.enum.map((v: any) => new JSON(v)) : null;
		this.maxProperties = ('maxProperties' in d) ? d.maxProperties as number : null;
		this.minProperties = ('minProperties' in d) ? d.minProperties as number : null;
		this.required = ('required' in d) ? d.required as string[] : null;
		this.items = ('items' in d) ? new JSONSchemaPropsOrArray(d.items) : null;
		this.allOf = Array.isArray(d.allOf) ? d.allOf.map((v: any) => new JSONSchemaProps(v)) : null;
		this.oneOf = Array.isArray(d.oneOf) ? d.oneOf.map((v: any) => new JSONSchemaProps(v)) : null;
		this.anyOf = Array.isArray(d.anyOf) ? d.anyOf.map((v: any) => new JSONSchemaProps(v)) : null;
		this.not = ('not' in d) ? new JSONSchemaProps(d.not) : null;
		this.properties = ('properties' in d) ? d.properties as { [key: string]: JSONSchemaProps } : {};
		this.additionalProperties = ('additionalProperties' in d) ? new JSONSchemaPropsOrBool(d.additionalProperties) : null;
		this.patternProperties = ('patternProperties' in d) ? d.patternProperties as { [key: string]: JSONSchemaProps } : {};
		this.dependencies = ('dependencies' in d) ? d.dependencies as { [key: string]: JSONSchemaPropsOrStringArray } : {};
		this.additionalItems = ('additionalItems' in d) ? new JSONSchemaPropsOrBool(d.additionalItems) : null;
		this.definitions = ('definitions' in d) ? d.definitions as { [key: string]: JSONSchemaProps } : {};
		this.externalDocs = ('externalDocs' in d) ? new ExternalDocumentation(d.externalDocs) : null;
...
export class CustomResourceDefinition {
	...
	constructor(data?: any) {
		...
		this.validation = ('validation' in d) ? new JSONSchemaProps(d.validation) : null;
		this.conditions = Array.isArray(d.conditions) ? d.conditions.map((v: any) => new CRDCondition(v)) : null;
...
export class FlexVolume {
	...
	constructor(data?: any) {
		...
		this.ro = ('ro' in d) ? d.ro as boolean : false;
		this.options = ('options' in d) ? d.options as { [key: string]: string } : {};
	}
}
...
export class ISCSIVolume {
	...
	constructor(data?: any) {
		...
		this.iscsi_interface = ('iscsi_interface' in d) ? d.iscsi_interface as string : '';
		this.fs = ('fs' in d) ? d.fs as string : '';
		this.ro = ('ro' in d) ? d.ro as boolean : false;
		this.portals = ('portals' in d) ? d.portals as string[] : null;
		this.chap_discovery = ('chap_discovery' in d) ? d.chap_discovery as boolean : false;
		this.chap_session = ('chap_session' in d) ? d.chap_session as boolean : false;
		this.secret = ('secret' in d) ? d.secret as string : '';
...
export class ScaleIOVolume {
	...
	constructor(data?: any) {
		...
		this.protection_domain = ('protection_domain' in d) ? d.protection_domain as string : '';
...
export class DownwardAPIVolumeFile {
	...
	constructor(data?: any) {
		...
		this.resource = ('resource' in d) ? new VolumeResourceFieldSelector(d.resource) : null;
		this.mode = ('mode' in d) ? d.mode as number : null;
	}
}
...
export class DownwardAPIVolume {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.items = ('items' in d) ? d.items as { [key: string]: DownwardAPIVolumeFile } : {};
		this.mode = ('mode' in d) ? d.mode as number : null;
	}
}
...
export class ProjectedVolume {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.sources = Array.isArray(d.sources) ? d.sources.map((v: any) => new VolumeProjection(v)) : null;
		this.mode = ('mode' in d) ? d.mode as number : null;
	}
}
...
export class Volume {
	...
	constructor(data?: any) {
		...
		this.FibreChannel = ('FibreChannel' in d) ? new FibreChannelVolume(d.FibreChannel) : null;
		...
		this.DownwardAPI = ('DownwardAPI' in d) ? new DownwardAPIVolume(d.DownwardAPI) : null;
...
export class ObjectReference {
	...
	constructor(data?: any) {
		...
		this.resourceVersion = ('resourceVersion' in d) ? d.resourceVersion as string : '';
...
export class CronJob {
	...
	constructor(data?: any) {
		...
		this.start_deadline = ('start_deadline' in d) ? d.start_deadline as number : null;
		this.concurrency = ('concurrency' in d) ? d.concurrency as string : '';
		this.max_success_history = ('max_success_history' in d) ? d.max_success_history as number : null;
		this.max_failure_history = ('max_failure_history' in d) ? d.max_failure_history as number : null;
		...
		this.active_deadline = ('active_deadline' in d) ? d.active_deadline as number : null;
		this.selector = ('selector' in d) ? new RSSelector(d.selector) : null;
		this.select_manually = ('select_manually' in d) ? d.select_manually as boolean : null;
		this.pod_meta = ('pod_meta' in d) ? new PodTemplateMeta(d.pod_meta) : null;
		this.volumes = ('volumes' in d) ? d.volumes as { [key: string]: Volume } : {};
		this.init_containers = Array.isArray(d.init_containers) ? d.init_containers.map((v: any) => new Container(v)) : null;
		this.containers = Array.isArray(d.containers) ? d.containers.map((v: any) => new Container(v)) : null;
		this.restart_policy = ('restart_policy' in d) ? d.restart_policy as string : '';
		this.termination_grace_period = ('termination_grace_period' in d) ? d.termination_grace_period as number : null;
		this.active_deadline = ('active_deadline' in d) ? d.active_deadline as number : null;
		...
		this.registry_secrets = ('registry_secrets' in d) ? d.registry_secrets as string[] : null;
		this.hostname = ('hostname' in d) ? d.hostname as string : '';
		this.affinity = Array.isArray(d.affinity) ? d.affinity.map((v: any) => new Affinity(v)) : null;
		this.scheduler_name = ('scheduler_name' in d) ? d.scheduler_name as string : '';
		this.tolerations = Array.isArray(d.tolerations) ? d.tolerations.map((v: any) => new Toleration(v)) : null;
		this.host_aliases = ('host_aliases' in d) ? d.host_aliases as string[] : null;
		this.priority = ('priority' in d) ? new Priority(d.priority) : null;
		this.active = Array.isArray(d.active) ? d.active.map((v: any) => new ObjectReference(v)) : null;
		this.last_scheduled = ('last_scheduled' in d) ? new Time(d.last_scheduled) : null;
	}
}
...
export class CertificateSigningRequest {
	...
	constructor(data?: any) {
		...
		this.conditions = Array.isArray(d.conditions) ? d.conditions.map((v: any) => new CertificateSigningRequestCondition(v)) : null;
	}
}
...
export class DaemonSet {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.replace_on_delete = ('replace_on_delete' in d) ? d.replace_on_delete as boolean : false;
		this.max_unavailable = ('max_unavailable' in d) ? new IntOrString(d.max_unavailable) : null;
		...
		this.host_aliases = ('host_aliases' in d) ? d.host_aliases as string[] : null;
		this.priority = ('priority' in d) ? new Priority(d.priority) : null;
		this.generation_observed = ('generation_observed' in d) ? d.generation_observed as number : 0;
		this.num_nodes_scheduled = ('num_nodes_scheduled' in d) ? d.num_nodes_scheduled as number : 0;
		this.num_nodes_misscheduled = ('num_nodes_misscheduled' in d) ? d.num_nodes_misscheduled as number : 0;
		this.num_nodes_desired = ('num_nodes_desired' in d) ? d.num_nodes_desired as number : 0;
		...
		this.num_unavailable = ('num_unavailable' in d) ? d.num_unavailable as number : 0;
		this.hash_collisions = ('hash_collisions' in d) ? d.hash_collisions as number : null;
	}
}
...
export class Deployment {
	...
	constructor(data?: any) {
		...
		this.progress_deadline = ('progress_deadline' in d) ? d.progress_deadline as number : null;
		this.selector = ('selector' in d) ? new RSSelector(d.selector) : null;
		this.pod_meta = ('pod_meta' in d) ? new PodTemplateMeta(d.pod_meta) : null;
		this.volumes = ('volumes' in d) ? d.volumes as { [key: string]: Volume } : {};
		this.init_containers = Array.isArray(d.init_containers) ? d.init_containers.map((v: any) => new Container(v)) : null;
		...
		this.condition = Array.isArray(d.condition) ? d.condition.map((v: any) => new DeploymentCondition(v)) : null;
		this.hash_collisions = ('hash_collisions' in d) ? d.hash_collisions as number : null;
	}
}
...
export class EndpointSubset {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.addrs = Array.isArray(d.addrs) ? d.addrs.map((v: any) => new EndpointAddress(v)) : null;
		this.unready_addrs = Array.isArray(d.unready_addrs) ? d.unready_addrs.map((v: any) => new EndpointAddress(v)) : null;
...
export class Endpoints {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.subsets = Array.isArray(d.subsets) ? d.subsets.map((v: any) => new EndpointSubset(v)) : null;
	}
}
...
export class EventWrapper {
	...
	constructor(data?: any) {
		...
		this.last_observed = ('last_observed' in d) ? new MicroTime(d.last_observed) : null;
...
export class HorizontalPodAutoscaler {
	...
	constructor(data?: any) {
		...
		this.generation_observed = ('generation_observed' in d) ? d.generation_observed as number : null;
		...
		this.current_percent_cpu = ('current_percent_cpu' in d) ? d.current_percent_cpu as number : null;
	}
}
...
export class IngressRule {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.host = ('host' in d) ? d.host as string : '';
		this.paths = Array.isArray(d.paths) ? d.paths.map((v: any) => new HTTPIngressPath(v)) : null;
	}
}
...
export class Ingress {
	...
	constructor(data?: any) {
		...
		this.backend_port = ('backend_port' in d) ? new IntOrString(d.backend_port) : null;
		this.tls = Array.isArray(d.tls) ? d.tls.map((v: any) => new IngressTLS(v)) : null;
		this.rules = Array.isArray(d.rules) ? d.rules.map((v: any) => new IngressRule(v)) : null;
		this.endpoints = Array.isArray(d.endpoints) ? d.endpoints.map((v: any) => new LoadBalancerIngress(v)) : null;
	}
}
...
export class InitializerConfig {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.rules = ('rules' in d) ? d.rules as { [key: string]: InitializerRule } : {};
	}
}
...
export class Job {
	...
	constructor(data?: any) {
		...
		this.host_aliases = ('host_aliases' in d) ? d.host_aliases as string[] : null;
		this.priority = ('priority' in d) ? new Priority(d.priority) : null;
		this.condition = Array.isArray(d.condition) ? d.condition.map((v: any) => new JobCondition(v)) : null;
...
export class LimitRangeItem {
	...
	constructor(data?: any) {
		...
		this.default_max = ('default_max' in d) ? d.default_max as { [key: string]: Quantity } : {};
		this.default_min = ('default_min' in d) ? d.default_min as { [key: string]: Quantity } : {};
		this.max_burst_ratio = ('max_burst_ratio' in d) ? d.max_burst_ratio as { [key: string]: Quantity } : {};
	}
}
...
export class LimitRangeWrapper {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.limits = Array.isArray(d.limits) ? d.limits.map((v: any) => new LimitRangeItem(v)) : null;
	}
}
...
export class CephFSPersistentVolume {
	...
	constructor(data?: any) {
		...
		this.path = ('path' in d) ? d.path as string : '';
		this.user = ('user' in d) ? d.user as string : '';
		this.secret = ('secret' in d) ? new CephFSPersistentSecretFileOrRef(d.secret) : null;
		this.ro = ('ro' in d) ? d.ro as boolean : false;
	}
}
...
export class PersistentVolume {
	...
	constructor(data?: any) {
		...
		this.status = ('status' in d) ? d.status as string : '';
		this.status_message = ('status_message' in d) ? d.status_message as string : '';
		...
		this.AzureFile = ('AzureFile' in d) ? new AzureFilePersistentVolume(d.AzureFile) : null;
		this.ScaleIO = ('ScaleIO' in d) ? new ScaleIOPersistentVolume(d.ScaleIO) : null;
		this.Local = ('Local' in d) ? new LocalVolume(d.Local) : null;
		this.StorageOS = ('StorageOS' in d) ? new StorageOSPersistentVolume(d.StorageOS) : null;
...
export class PersistentVolumeClaimWrapper {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.storage_class = ('storage_class' in d) ? d.storage_class as string : null;
		this.volume = ('volume' in d) ? d.volume as string : '';
		this.access_modes = ('access_modes' in d) ? d.access_modes as string[] : null;
		this.storage = ('storage' in d) ? d.storage as string : '';
		this.selector = ('selector' in d) ? new RSSelector(d.selector) : null;
		this.phase = ('phase' in d) ? d.phase as string : '';
		this.access_modes = ('access_modes' in d) ? d.access_modes as string[] : null;
		this.storage = ('storage' in d) ? d.storage as string : '';
		this.condition = Array.isArray(d.condition) ? d.condition.map((v: any) => new PersistentVolumeClaimCondition(v)) : null;
	}
}
...
export class Pod {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.version = ('version' in d) ? d.version as string : '';
		this.condition = Array.isArray(d.condition) ? d.condition.map((v: any) => new PodCondition(v)) : null;
...
export class PodDisruptionBudget {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.max_evictions = ('max_evictions' in d) ? new FloatOrString(d.max_evictions) : null;
		this.min_pods = ('min_pods' in d) ? new FloatOrString(d.min_pods) : null;
		this.selector = ('selector' in d) ? new RSSelector(d.selector) : null;
		this.generation_observed = ('generation_observed' in d) ? d.generation_observed as number : 0;
		this.disrupted_pods = ('disrupted_pods' in d) ? d.disrupted_pods as { [key: string]: Time } : {};
		this.allowed_disruptions = ('allowed_disruptions' in d) ? d.allowed_disruptions as number : 0;
		this.current_healthy_pods = ('current_healthy_pods' in d) ? d.current_healthy_pods as number : 0;
		this.desired_healthy_pods = ('desired_healthy_pods' in d) ? d.desired_healthy_pods as number : 0;
...
export class PodPreset {
	...
	constructor(data?: any) {
		...
		this.env = Array.isArray(d.env) ? d.env.map((v: any) => new Env(v)) : null;
		this.volumes = ('volumes' in d) ? d.volumes as { [key: string]: Volume } : {};
		this.mounts = Array.isArray(d.mounts) ? d.mounts.map((v: any) => new VolumeMount(v)) : null;
	}
}
...
export class UIDPolicy {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.policy = ('policy' in d) ? d.policy as string : '';
		this.ranges = Array.isArray(d.ranges) ? d.ranges.map((v: any) => new IDRange(v)) : null;
	}
}
...
export class PodSecurityPolicy {
	...
	constructor(data?: any) {
		...
		this.host_mode = ('host_mode' in d) ? d.host_mode as string[] : null;
		this.host_port_ranges = Array.isArray(d.host_port_ranges) ? d.host_port_ranges.map((v: any) => new HostPortRange(v)) : null;
		...
		this.allow_escalation = ('allow_escalation' in d) ? d.allow_escalation as boolean : null;
		this.allow_escalation_default = ('allow_escalation_default' in d) ? d.allow_escalation_default as boolean : null;
		this.host_paths_allowed = ('host_paths_allowed' in d) ? d.host_paths_allowed as string[] : null;
		this.flex_volumes_allowed = ('flex_volumes_allowed' in d) ? d.flex_volumes_allowed as string[] : null;
	}
}
...
export class ReplicaSet {
	...
	constructor(data?: any) {
		...
		this.condition = Array.isArray(d.condition) ? d.condition.map((v: any) => new ReplicaSetCondition(v)) : null;
	}
}
...
export class ReplicationController {
	...
	constructor(data?: any) {
		...
		this.replicas = ('replicas' in d) ? d.replicas as number : null;
		this.ready_seconds = ('ready_seconds' in d) ? d.ready_seconds as number : 0;
		this.selector = ('selector' in d) ? d.selector as { [key: string]: string } : {};
		this.pod_meta = ('pod_meta' in d) ? new PodTemplateMeta(d.pod_meta) : null;
		this.volumes = ('volumes' in d) ? d.volumes as { [key: string]: Volume } : {};
		this.init_containers = Array.isArray(d.init_containers) ? d.init_containers.map((v: any) => new Container(v)) : null;
		this.containers = Array.isArray(d.containers) ? d.containers.map((v: any) => new Container(v)) : null;
		...
		this.priority = ('priority' in d) ? new Priority(d.priority) : null;
		this.generation_observed = ('generation_observed' in d) ? d.generation_observed as number : 0;
		this.replicas_status = ('replicas_status' in d) ? new ReplicationControllerReplicasStatus(d.replicas_status) : null;
		this.condition = Array.isArray(d.condition) ? d.condition.map((v: any) => new ReplicationControllerCondition(v)) : null;
	}
}
...
export class ReplicationControllerWrapper {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.replication_controller = new ReplicationController(d.replication_controller);
	}
}
...
export class Secret {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.string_data = ('string_data' in d) ? d.string_data as { [key: string]: string } : {};
		this.data = ('data' in d) ? d.data as { [key: string]: []uint8 } : {};
		this.type = ('type' in d) ? d.type as string : '';
	}
}
...
export class Service {
	...
	constructor(data?: any) {
		...
		this.type = ('type' in d) ? d.type as string : '';
		this.selector = ('selector' in d) ? d.selector as { [key: string]: string } : {};
		this.external_ips = ('external_ips' in d) ? d.external_ips as string[] : null;
		this.port = ('port' in d) ? new ServicePort(d.port) : null;
		this.node_port = ('node_port' in d) ? d.node_port as number : 0;
		this.ports = Array.isArray(d.ports) ? d.ports.map((v: any) => new NamedServicePort(v)) : null;
		this.cluster_ip = ('cluster_ip' in d) ? d.cluster_ip as string : '';
		this.unready_endpoints = ('unready_endpoints' in d) ? d.unready_endpoints as boolean : false;
		...
		this.lb_client_ips = ('lb_client_ips' in d) ? d.lb_client_ips as string[] : null;
		this.healthcheck_port = ('healthcheck_port' in d) ? d.healthcheck_port as number : 0;
		this.endpoints = Array.isArray(d.endpoints) ? d.endpoints.map((v: any) => new LoadBalancerIngress(v)) : null;
	}
}
...
export class LoadBalancer {
	...
	constructor(data?: any) {
		...
		this.HealthCheckNodePort = ('HealthCheckNodePort' in d) ? d.HealthCheckNodePort as number : 0;
		this.Ingress = Array.isArray(d.Ingress) ? d.Ingress.map((v: any) => new LoadBalancerIngress(v)) : null;
	}
}
...
export class ServiceAccount {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.secrets = Array.isArray(d.secrets) ? d.secrets.map((v: any) => new ObjectReference(v)) : null;
		this.registry_secrets = ('registry_secrets' in d) ? d.registry_secrets as string[] : null;
...
export class StatefulSet {
	...
	constructor(data?: any) {
		...
		this.service = ('service' in d) ? d.service as string : '';
		this.pvcs = Array.isArray(d.pvcs) ? d.pvcs.map((v: any) => new PersistentVolumeClaim(v)) : null;
		this.selector = ('selector' in d) ? new RSSelector(d.selector) : null;
		this.pod_meta = ('pod_meta' in d) ? new PodTemplateMeta(d.pod_meta) : null;
		this.volumes = ('volumes' in d) ? d.volumes as { [key: string]: Volume } : {};
		this.init_containers = Array.isArray(d.init_containers) ? d.init_containers.map((v: any) => new Container(v)) : null;
...
export class StorageClassWrapper {
	...
	constructor(data?: any) {
		...
		this.allow_expansion = ('allow_expansion' in d) ? d.allow_expansion as boolean : null;
...
export class MarshalledVolume {
	...
	constructor(data?: any) {
		...
		this.ExtraFields = ('ExtraFields' in d) ? d.ExtraFields as { [key: string]: any } : {};
	}
}
...
export class Webhook {
	...
	constructor(data?: any) {
		...
		this.rules = Array.isArray(d.rules) ? d.rules.map((v: any) => new WebhookRuleWithOperations(v)) : null;
		this.selector = ('selector' in d) ? new RSSelector(d.selector) : null;
	}
}
...
export class WebhookConfig {
	...
	constructor(data?: any) {
		...
		this.labels = ('labels' in d) ? d.labels as { [key: string]: string } : {};
		this.annotations = ('annotations' in d) ? d.annotations as { [key: string]: string } : {};
		this.webhooks = ('webhooks' in d) ? d.webhooks as { [key: string]: Webhook } : {};
	}
}
...
export class LabelSelector {
	...
	constructor(data?: any) {
		const d: any = (data && typeof data === 'object') ? data : {};
		this.matchLabels = ('matchLabels' in d) ? d.matchLabels as { [key: string]: string } : {};
		this.matchExpressions = Array.isArray(d.matchExpressions) ? d.matchExpressions.map((v: any) => new LabelSelectorRequirement(v)) : null;
	}
}
