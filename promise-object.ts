 ...
 */
export type Unwrap<T> = T extends PromiseLike<infer U1> ? UnwrapSimple<U1> : UnwrapSimple<T>;
declare type primitive = Function | string | number | boolean | undefined | null;
/**
 * Handles encountering basic types when unwrapping.
 */
type UnwrapSimple<T> = T extends primitive ? T : T extends Array<infer U> ? Unwrap<U>[] : T extends object ? UnwrappedObject<T> : never;
