...
export const header = `# File Generated by the Kite™️ Config Generation tool by @brandonkal.\n`
...
export function log(config: string, includeHeader = true) {
	console.log(includeHeader ? header : '' + config.trimEnd())
}
 ...
 *
 * Use this function when several "files" should be generated. Note that Kite does not write anything to disk. The user is expected to then filter this output and write the files to disk as required.
 * @example
 * ```ts
 * if (import.meta.main) {
 * 	multifile([
